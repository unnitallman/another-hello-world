...
# curl -s -L "https://raw.githubusercontent.com/bigbinary/fashop/master/.scripts/sync_with_fashop.sh" | bash
...
raw_base_url="https://raw.githubusercontent.com/bigbinary/fashop/master"
declare -a configs=(
  ".eslintrc.js"
  ".eslintignore"
